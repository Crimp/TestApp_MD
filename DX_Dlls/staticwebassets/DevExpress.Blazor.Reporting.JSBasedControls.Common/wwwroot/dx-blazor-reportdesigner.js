...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n// extracted by mini-css-extract-plugin\n\n\n//# sourceURL=webpack:///./Content/bootstrap-override.css?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n// extracted by mini-css-extract-plugin\n\n\n//# sourceURL=webpack:///./Content/imports.css?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils */ \"./Scripts/utils.js\");\n/* harmony import */ var _themesOverride__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./themesOverride */ \"./Scripts/themesOverride.js\");\n/* harmony import */ var _themesOverride__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_themesOverride__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _common_root_registration__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./_common-root-registration */ \"./Scripts/_common-root-registration.js\");\n/* harmony import */ var _common_root_registration__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_common_root_registration__WEBPACK_IMPORTED_MODULE_2__);\n/* harmony import */ var _common_scripts_registration__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./_common-scripts-registration */ \"./Scripts/_common-scripts-registration.js\");\n\r\n\r\n\r\n\r\n\r\nwindow.DEBUG = { ko: window.ko };\r\nwindow.DxReporting.ReportDesigner = window.DxReporting.ReportDesigner ||\r\n{\r\n    Init: function(initDesignerOptions, id, dotnetHelper) {\r\n        const designerModel = initDesignerOptions.model;\r\n        if(!(window[\"DevExpress\"] && window[\"DevExpress\"].RichEdit) && window[\"DxBlazorOffice\"]) {\r\n            DevExpress.Reporting.Designer.Controls.RichEdit.setRichEditInstance(DxBlazorOffice.RichEdit);\r\n            DevExpress.Reporting.Designer.Controls.getRichEditSurface(() =>\r\n                DevExpress.Reporting.Designer.Controls.RichEdit.XRRichModernSurface\r\n            );\r\n            DevExpress.Reporting.Designer.Controls.registerRichEditInline((selection) =>\r\n                new DevExpress.Reporting.Designer.Controls.RichEdit.Internal.InlineRichEditControl(selection)\r\n            );\r\n        }\r\n        this.DesignerOptions = typeof (designerModel) === 'object' ? designerModel : JSON.parse(designerModel);\r\n        this.DesignerOptions.designerModel = ko.observable();\r\n        (0,_utils__WEBPACK_IMPORTED_MODULE_0__.processClientSideEvents)(this.DesignerOptions.callbacks || {});\r\n        var documentIdSubscription = function(newDocumentId) {\r\n            dotnetHelper.invokeMethodAsync(\"SetCurrentDocumentId\", newDocumentId);\r\n        };\r\n        var reportIdSubscription = function(newReportId) {\r\n            dotnetHelper.invokeMethodAsync(\"SetCurrentReportId\", newReportId);\r\n        };\r\n        var subscriptions = [];\r\n        var subscribeToNewModel = function(newModel) {\r\n            if(!newModel) return;\r\n            var reportPreview = newModel.reportPreviewModel.reportPreview;\r\n            subscriptions.push({\r\n                dispose: reportPreview.events.on('propertyChanged', (args) => {\r\n                    if(args.propertyName === 'documentId') {\r\n                        documentIdSubscription(reportPreview.documentId);\r\n                    }\r\n                    if(args.propertyName === 'reportId') {\r\n                        reportIdSubscription(reportPreview.reportId);\r\n                    }\r\n                })\r\n            });\r\n        };\r\n        subscriptions.push(this.DesignerOptions.designerModel.subscribe(subscribeToNewModel));\r\n\r\n        var liveCircleModel = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.processModelLiveCircle)(id, subscriptions, (element) => {\r\n            (0,_common_scripts_registration__WEBPACK_IMPORTED_MODULE_3__.processControlOptions)(initDesignerOptions, dotnetHelper);\r\n            new DevExpress.Reporting.Designer.DxReportDesigner(element, this.DesignerOptions).render()\r\n        });\r\n        this.DisposeCallback = liveCircleModel.disposeCallback;\r\n    },\r\n    OpenReport: function(reportName) {\r\n        (0,_utils__WEBPACK_IMPORTED_MODULE_0__.applyViewModelMethod)(this.DesignerOptions.designerModel(), \"openReport\", reportName);\r\n    },\r\n    SaveReport: function() {\r\n        var currentTab = this.DesignerOptions.designerModel().navigateByReports.currentTab();\r\n        return DevExpress.Reporting.Designer.ReportStorageWeb.setData(currentTab.report().serialize(), currentTab.url());\r\n    },\r\n    DesignerOptions: null,\r\n    DisposeCallback: null\r\n};\r\n\n\n//# sourceURL=webpack:///./Scripts/dx-reportdesigner.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n// extracted by mini-css-extract-plugin\n\n\n//# sourceURL=webpack:///./node_modules/ace-builds/css/ace.css?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n// extracted by mini-css-extract-plugin\n\n\n//# sourceURL=webpack:///./node_modules/ace-builds/css/theme/ambiance.css?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n// extracted by mini-css-extract-plugin\n\n\n//# sourceURL=webpack:///./node_modules/ace-builds/css/theme/dreamweaver.css?");
...
/******/ 	__webpack_require__("./Scripts/dx-reportdesigner.js");
/******/ 	__webpack_require__("./Content/imports.css");
/******/ 	__webpack_require__("./node_modules/ace-builds/css/ace.css");
/******/ 	__webpack_require__("./node_modules/ace-builds/css/theme/dreamweaver.css");
/******/ 	__webpack_require__("./node_modules/ace-builds/css/theme/ambiance.css");
/******/ 	var __webpack_exports__ = __webpack_require__("./Content/bootstrap-override.css");
/******/ 	
/******/ })()
;