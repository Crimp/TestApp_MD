import { f as dateTimeEditTagName } from './constants-24.23.js';
import { D as DxDateEditBase, T as TimeEditRootKbdStrategy } from './dx-date-edit-base-24.2.js';
...
class DxDateTimeEdit extends DxDateEditBase {
    createKeyboardStrategy() {
        return new TimeEditRootKbdStrategy(this);
    }
}
customElements.define(dateTimeEditTagName, DxDateTimeEdit);
function loadModule() { }
const dxDateTimeEdit = { loadModule, adaptiveDropdownComponents, calendarComponent };

export { DxDateTimeEdit, dxDateTimeEdit as default };
//# sourceMappingURL=dx-date-time-edit-24.2.js.map
